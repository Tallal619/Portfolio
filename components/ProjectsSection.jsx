      ...
      >
        <div className="grid grid-cols-1 gap-4 px-2 mt-10 lg:gap-10 md:grid-cols-2 place-items-center md:px-10 lg:px-28">
          ...
          <ProjectCard
            ...
            title="Portfolio"
            desc="Stunning portfolio made using the best of my skills."
          ...
          <ProjectCard
            ...
            desc="A Dental Clinic website with Google Maps, customer appointment forms, and WhatsApp direct message"
          ...
          <ProjectCard
            ...
            title="DIGI Cricket"
            desc="ESPN Cricket Clone Completely Coded And developed from scratch."
